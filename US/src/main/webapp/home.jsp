...
<h1><center>URBAN SPOON</center></h1>
</head>
	...
	<div class="page">
		...
		<div id="restaurant_registration">
			...
			<form name="restaurant_registration_form" method="post"
				...
				<label>Government Registration ID</label><input type="text" name="govtregistrationid"><br>
				
				<label>Restaurant Logo</label><input type="file" name="registrationlogo"><br> 
