	...
	<div class="page">
		...
		<div>
								...
								<table border="1">
									<c:forEach items="${restaurant.branchesList}" var="branch">
										<tr>
											...
											<td><a
												href="branchfeedback?action=branch_feedback&restaurant_id=${restaurant.id}&branch_id=${branch.id}">Add
													FeedBack</a></td>
											<td>
												<table border="1">
																...
																<table>
																	<c:forEach items="${cuisine.recipesList}" var="recipe">
																		<tr>
																			...
																			<td>${recipe.price}</td>
																			<td><a
																				href="recipefeedback?action=recipe_feedback&recipeid=${recipe.id}&branchid=${branch.id}&restaurantid=${restaurant.id}">Add
																					FeedBack</a></td>
																		</tr>
																	</c:forEach>
																</table>
			...
			<div id="branch_feedback">
				...
				<form name="branch_feedback_form" method="post" action="addbranchfeedback">
			 ...
			 <select name="rating">
					...
					<input type="date" name="visitedDate"><br>
					<label>FeedbackType</label>
					 <select name="feedbacktypeid">
			...
			<div id="recipe_feedback">
				...
				<form name="recipe_feedback_form" method="post"
					...
					<label>Visited Date</label><input type="date" name="visitedDate"><br>
